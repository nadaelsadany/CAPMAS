            ...
            <div *ngIf="activeTab === 'entities'" class="animate-fade-in-up">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <a *ngFor="let entity of linkedEntities" 
                  ...
                  <div class="absolute top-4 left-4 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button (click)="$event.preventDefault(); $event.stopPropagation(); unlinkEntity(entity.id)" 
