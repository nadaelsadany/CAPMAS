...
@Component({
      ...
      <aside class="w-72 bg-white flex flex-col shadow-xl z-20 border-l border-gray-100 h-full">
        ...
        <div class="flex-1 overflow-y-auto py-8 px-4 custom-scrollbar">
          ...
          <ng-container *appHasRole="['SUPER_ADMIN']">
            ...
            <a routerLink="/super-admin" [routerLinkActiveOptions]="{exact: true}" routerLinkActive="active-link" class="nav-link group">
            ...
            <a routerLink="/super-admin/administrations" routerLinkActive="active-link" class="nav-link group">
            ...
            <a routerLink="/super-admin/external-entities" routerLinkActive="active-link" class="nav-link group">
            ...
            <a routerLink="/super-admin/users" routerLinkActive="active-link" class="nav-link group">
            ...
            <a routerLink="/super-admin/roles" routerLinkActive="active-link" class="nav-link group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" /></svg>
              <span>الصلاحيات والأدوار</span>
            </a>
            <a routerLink="/super-admin/audit-log" routerLinkActive="active-link" class="nav-link group">
            ...
            <a routerLink="/settings" routerLinkActive="active-link" class="nav-link group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform"><path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.99l1.003.828c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z" /></svg>
          ...
          <ng-container *appHasRole="['ADMINISTRATION_ADMIN', 'ADMINISTRATION_REVIEWER']">
            ...
            <a routerLink="/administration-admin/reports" [routerLinkActiveOptions]="{exact: true}" routerLinkActive="active-link" class="nav-link group">
            ...
            <a routerLink="/administration-admin/builder" routerLinkActive="active-link" class="nav-link group">
          ...
          <ng-container *appHasRole="['EXTERNAL_ENTITY_ADMIN']">
            ...
            <a routerLink="/external-entity-admin" [routerLinkActiveOptions]="{exact: true}" routerLinkActive="active-link" class="nav-link group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" /></svg>
              <span>لوحة التحكم</span>
            </a>
          </ng-container>

          <!-- Decision Maker Links -->
          <ng-container *appHasRole="['DECISION_MAKER']">
            <p class="text-[10px] text-gray-400 uppercase mb-4 mt-2 px-2 tracking-[0.2em] font-black">المتابعة والتحليل</p>
            <a routerLink="/decision-maker" [routerLinkActiveOptions]="{exact: true}" routerLinkActive="active-link" class="nav-link group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" /></svg>
              <span>الرئيسية</span>
            </a>
            <a routerLink="/decision-maker/administrations" routerLinkActive="active-link" class="nav-link group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18" /></svg>
              <span>الإدارات العامة</span>
            </a>
            <a routerLink="/decision-maker/external-entities" routerLinkActive="active-link" class="nav-link group">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6.75h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h18" /></svg>
              <span>الجهات الخارجية</span>
            </a>
          </ng-container>
  ...
  styles: [`
    .nav-link {
      @apply flex items-center gap-3 px-4 py-3.5 mb-2 rounded-2xl transition-all text-gray-600;
    }
    .nav-link:hover {
      @apply bg-gray-50;
    }
    .active-link {
      @apply bg-capmas-primary text-white font-bold shadow-lg shadow-blue-100 border-r-4 border-capmas-accent;
    }
    .active-link svg {
      @apply text-white;
    }
    .nav-link.active-link:hover {
      @apply bg-blue-50 text-capmas-primary shadow-sm;
    }
    .nav-link.active-link:hover svg {
      @apply text-capmas-primary;
    }
  `]
})
