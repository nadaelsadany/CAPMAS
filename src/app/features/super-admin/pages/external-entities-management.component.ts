  ...
  template: `
    <div class="p-8 max-w-7xl mx-auto h-full flex flex-col text-right" dir="rtl">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <button (click)="openCreateModal()" class="bg-capmas-primary hover:bg-opacity-90 text-white px-6 py-3 rounded-xl shadow-lg shadow-blue-100 transition-all active:scale-95 font-bold flex items-center gap-2">
...
export class ExternalEntitiesManagementComponent implements OnInit, OnDestroy {
  ...
  navigateToDetails(id: string) {
    this.router.navigate(['/super-admin/external-entities', id]);
  }
